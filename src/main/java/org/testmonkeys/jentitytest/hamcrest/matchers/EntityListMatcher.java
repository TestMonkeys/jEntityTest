...
import org.testmonkeys.jentitytest.EntityListComparator;
 ...
 */
public class EntityListMatcher<T> extends AbstractJEntityMatcher<T> {

    private final Object expected;
    private String textualOutput;

    public EntityListMatcher(Object expected) {
