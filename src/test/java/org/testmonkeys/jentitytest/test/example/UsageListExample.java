...
public class UsageListExample {
    ...
    public void userExample_EntityTest() {
        ...
        actual.add(actualUser);
        List<User> expected = new ArrayList<>();
        expected.add(expectedUser);

        Assert.assertThat(actual, EntityList.isEqualTo(expected));
...
//        emails.add("flimsyj@company.com");
    ...
    private User getExpectedUser() {
        ...
        user.setCreatedDate(LocalDateTime.now().plus(5, ChronoUnit.MINUTES));
        user.setId(1);
